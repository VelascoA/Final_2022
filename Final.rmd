...
The last group to be examined by the study is drug users. The vaccine is ineffective for those who use drugs. It can be seen as early as the graphical result that show, 85% of those who took the vaccine still contracting COVID and only about 15% of those who took the placebo getting the virus. The numerical results show 97% of those vaccinated with the vaccine remained okay but 99.4% of those who were given the placebo remained okay, informing us the vaccine is in effective.The inferential results give us the odds ratio of .2 with and estimated .178 telling us that those who received the placebo  are .178 times more likely to contract the virus. Lastly  the efficacy results conclude the vaccine is only 15% effective. Slightly more effective for drug users than for the LGBTQ community but still not close to as effective as stright non drug using males and females. 
