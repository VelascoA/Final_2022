...
The study is attempting to see how effective a COVID-19 vaccination is, then breaking it down into different categories such as male. With males conducted in the study it can be see through the data the vaccination is highly effective. All sets of provided data support this statement. Graphical results conclude that 65% of those who took the placebo vaccine got infected with COVID-19, where as 30% who received the vaccine got the virus. The numerical results show 3% of those who had the placebo  were infected with the virus and 1% who received the COVID-19 vaccine caught the virus. Inferential results inform us of the odds ratio of 2 telling us that 2.09% of those who took the placebo are less likely to contract COVID-19. As well as the p value being so small shows that the chances if there were no difference between males who received the placebo and who had gotten the vaccine. Lastly the efficacy conclusion was the vaccination was 59% effective. With all these results the COVID-19 vaccine made is highly effective when it comes to males. 
...
The graphical results for those who use drugs is ineffective. With 85% of those who took the vaccine still contracting COVID and only about 15% of those who took the placebo getting the virus. Proving that that the vaccination is no good for drug users.
...
The last group to be examined by the study is drug users. The vaccine is ineffective for those who use drugs. It can be seen as early as the graphical result that show, 85% of those who took the vaccine still contracting COVID and only about 15% of those who received the placebo getting the virus. The numerical results show 97% of those vaccinated with the vaccine remained okay but 99.4% of those who were given the placebo remained okay, informing us the vaccine is in effective.The inferential results give us the odds ratio of .2 with and estimated .178 telling us that those who received the placebo  are .178 times more likely to contract the virus. Lastly  the efficacy results conclude the vaccine is only 15% effective. Slightly more effective for drug users than for the LGBTQ community but still not close to as effective as straight non drug using males and females. 


# Overall final Conclusion 

The study being examined is if the COVID-19 vaccination is effective and how it effects different groups of individuals. Going through the groups of males, females, LGBTQ, and drug users the vaccination has different effects through out. For males it can be seen that the vaccination is greatly effective with efficacy results concluding it is 59% effective and the numerical results stating 1% who received vaccine caught the virus. After looking at the results foe females it can be seen that the vaccination is just as effective. With matching efficacy result of 59%, the inferential results showing those who got the placebo are 1.43% less like to contract than those who received the vaccine. 

However when starting to look into the two other groups the results start to change drastically. For the LGBTQ community the vaccine is not effective. All the data points to this graphical results for the LGBTQ show 80% of those who received the vaccine contracted the virus where around only 10% who took the placebo caught COVID. The efficacy results show the vaccine is only 13% effective with numerical results showing 3% who got the vaccine still got COVID, were as .5% who took the placebo got COVID. Then looking at drug users the results again change but only slightly. The numerical results show 3% of those who received the vaccine contracted COVID where .6% of those with the placebo vaccination caught the virus, with the efficacy at 15%. All the data points at the vaccination can be effective but only for straight non drug using males and females. the data also points that for those in the LGBTQ community and those who use drugs the vaccination does not work and could possibly help you catch COVID 19. 
